...
public class PanelIngredientes extends javax.swing.JPanel {
    ...
    public PanelIngredientes() {
        ...
        jtaIngredientes.setText(recetaSelec.getIngredientes());
    ...
    private void jpBtnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpBtnGuardarMouseClicked
        ...
        String nombreReceta = VerRecetas.jlListaRecetas.getSelectedValue();
        RecetaClase recetaSelec = f.VerReceta(nombreReceta);
        f.EditarIngredientes(recetaSelec.getTitulo(), jtaIngredientes);
        f.AvisoPane("Exito", "Se han modificado los ingredientes de: " + recetaSelec.getTitulo());
